...
7. **Elke PR vult het sjabloon (`.github/pull_request_template.md`) volledig in.** Twee vragen mogen nooit leeg blijven: wat er voor een bezoeker of voor Rob verandert, in gewone taal zonder vaktermen, en waar hij het zelf kan zien. Levert deze wijziging niets zichtbaars op in de ontwikkelomgeving van de pull request — bijvoorbeeld een werkschema dat pas bij de volgende release iets doet — dan hoort daar de plek te staan waar het wél zichtbaar wordt, met erbij wanneer. Aanleiding: PR #161 werkte goed, maar Rob moest er zelf naar vragen om te snappen wat hij moest testen.
